...
# data
DATA_DIR="${BASE_PATH}/processed_data/rams/qwen/"
# hp
BATCH_SIZE=2
LR=0.0002
GRAD_ACC=8
...
MAX_LENGTH=768
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen3/span_distillm/0.6B_4B_rams_srkl_2"
# seed
SEED=42
...
OPTS+=" --teacher-peft-path results/qwen3/sft_4B_rams/e5-bs2-lr0.0001-G8-N2-NN1-lora-32-64-0.05/1155"
