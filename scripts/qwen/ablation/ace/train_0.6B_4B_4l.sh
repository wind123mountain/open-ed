...
MAX_LENGTH=768
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen3/ablation/0.6B_4B_ace_4l"
# seed
SEED=42
...
OPTS+=" --teacher-peft-path results/qwen3_distill/sft_4B_ace/e5-bs2-lr0.0001-G8-N2-NN1-lora-32-64-0.05/490"
...
OPTS+=" --teacher_layer_mapping 27 30 33 36"
OPTS+=" --student_layer_mapping 19 22 25 28"
