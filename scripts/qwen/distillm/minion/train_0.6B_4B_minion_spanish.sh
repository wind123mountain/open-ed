#! /bin/bash
# DistiLLM SFKL baseline (no span loss): Qwen3-4B teacher -> Qwen3-0.6B student
# on MINION Spanish. Used as baseline against EventKD (span_distillm) variant.
...
MAX_LENGTH=768
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen3/distillm_0.6B_4B_minion_spanish_sfkl"
# seed
SEED=42
