#! /bin/bash
# CSD baseline (no span loss): Qwen3-4B teacher -> Qwen3-0.6B student on
# MINION Spanish. Concrete Score Distillation variant.
...
MAX_LENGTH=768
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen3/distillm_0.6B_4B_minion_spanish_csd"
# seed
SEED=42
