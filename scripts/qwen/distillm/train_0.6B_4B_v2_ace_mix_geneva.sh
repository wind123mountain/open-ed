...
CKPT="results/qwen3/distillm_0.6B_4B_geneva/305"

TEACHER_CKPT_NAME="qwen3-4B"
TEACHER_CKPT="Qwen/Qwen3-4B-Instruct-2507"
# data
DATA_DIR="${BASE_PATH}/processed_data/ace_mix_geneva/qwen/"
# hp
BATCH_SIZE=2
LR=0.00005
GRAD_ACC=8
...
MAX_LENGTH=768
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen3/distillm_0.6B_4B_ace_mix"
# seed
SEED=42
...
OPTS+=" --t-max-length 1024"
OPTS+=" --max-prompt-length 640"
# runtime
OPTS+=" --do-train"
OPTS+=" --do-valid"
OPTS+=" --do-eval"
