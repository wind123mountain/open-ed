...
# data
DATA_DIR="${BASE_PATH}/processed_data/geneva/llama/"
# hp
BATCH_SIZE=2
LR=0.0002
GRAD_ACC=1
...
MAX_LENGTH=768
# runtime
SAVE_PATH="${BASE_PATH}/results/llama/distillm_1B_8B_geneva_amid"
# seed
SEED=42
...
DEFAULT_TEACHER_SFT_DIR="${BASE_PATH}/results/llama/sft_8B_geneva"
...
OPTS+=" --amid-alpha 0.5"
OPTS+=" --amid-lam 0.1"
OPTS+=" --amid-div-name fkl"
OPTS+=" --amid-div-order rq"
# gen
OPTS+=" --do-sample"
OPTS+=" --top-k 0"
OPTS+=" --top-p 0.95"
