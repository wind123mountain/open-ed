...
MAX_LENGTH=768
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen3/span_distillm/0.6B_4B_maven_srkl_2"
# seed
SEED=42
...
OPTS+=" --teacher-peft-path results/qwen3/sft_4B_maven/e6-bs2-lr0.0005-G8-N2-NN1-lora-64-128-0.1/4926"
...
OPTS+=" --teacher_layer_mapping 36"
OPTS+=" --student_layer_mapping 28"
