...
MAX_LENGTH=768
# runtime
SAVE_PATH="${BASE_PATH}/results/qwen3/span_distillm/0.6B_4B_ace_srkl_2_te2"
# seed
SEED=42
...
OPTS+=" --teacher-peft-path results/qwen3/sft_4B_ace/e5-bs2-lr0.0001-G8-N2-NN1-lora-32-64-0.05/196"
